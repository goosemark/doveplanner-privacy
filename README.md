...
If you save a spot, its name, coordinates, and time zone are stored locally in the app. They remain until you delete the spot or remove the app’s data. This information may be included in backups managed by your device and Apple account settings. The app does not separately sync saved spots or upload them to a developer-operated service.

Current weather and manual planning inputs are held in memory while using the app. Manual adjustments do not change the live weather data.

## Your choices

You can revoke location access in iOS Settings at any time and continue using location search or manual planning. To delete a saved spot, open Your locations, swipe left on the spot, and choose Delete. Removing the app removes its local data; manage any existing backups through your device or Apple account settings.

## Contact

Questions about privacy or support: egossling@me.com

© 2026 Eric Gossling. All rights reserved.
